...
def main():
    ...
    for directory, name in BOARDS:
        ...
        extra = (('\nLa colocación alinea J104, J108, J107, J113, J109, J105 y J106 con '
                  ...
                  'a las cargas, las salidas de U602, la UART, BOOT0, el puente H, la '
                  'telemetría con sus divisores y un plano GND_UI en '
                  'B.Cu: 1156 segmentos y 232 vías. Las fases '
                  ...
                  'DRC de esta etapa tiene 0 infracciones y ningún aviso. '
                  'Quedan 29 conexiones abiertas, todas de señal, y tres diferencias de '
