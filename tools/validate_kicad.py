...
def main():
    ...
    for directory, name in BOARDS:
        ...
        extra = (('\nLa colocación alinea J104, J108, J107, J113, J109, J105 y J106 con '
                  ...
                  'salida de 24 V y un plano GND_UI en B.Cu: 152 segmentos y 23 vías. Las fases '
                  ...
                  'DRC de esta etapa tiene 0 infracciones. '
                  'Quedan 273 conexiones abiertas y seis diferencias de paridad: MH1–MH3 y las '
