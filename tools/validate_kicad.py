...
def main():
    ...
    for directory, name in BOARDS:
        ...
        extra = (('\nLa colocación alinea J104, J108, J107, J113, J109, J105 y J106 con '
                  ...
                  'patrón de patas provisional. El routing reproducible conecta todas las '
                  ...
                  'con el bus del LCD hasta J104: 1250 segmentos y 287 vías. Las fases de '
                  'carga van duplicadas en F.Cu y B.Cu con cobre de 1 oz; la de las cargas '
                  'conmutadas, con un bloque de B.Cu bajo el pie del disipador. La barrera de 8 mm '
