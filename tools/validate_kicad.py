...
def main():
    ...
    for directory, name in BOARDS:
        ...
        extra = (('\nLa colocación alinea J104, J108, J107, J113, J109, J105 y J106 con '
                  ...
                  'de 24 V a 12 V, el buck de 3,3 V con su telemetría, las etapas de calentador, '
                  'bomba y molinillo con sus enclavamientos, la cabecera SWD, las órdenes al '
                  'supervisor, los raíles de 12 V, 3,3 V y del frontal, las órdenes del STM32 '
                  'a las cargas, las salidas de U602 y un plano GND_UI en '
                  'B.Cu: 1079 segmentos y 220 vías. Las fases '
                  ...
                  'dominio de red es contiguo, reserva el disipador de los tres triacs, y el '
                  'DRC de esta etapa tiene 0 infracciones y un aviso intencional de extremo '
                  'suelto, donde la fila de corriente del puente H espera PA3. '
                  'Quedan 44 conexiones abiertas, todas de señal, y tres diferencias de '
                  'paridad, los taladros mecánicos MH1–MH3.\n\n'
