...
def main():
    ...
    for directory, name in BOARDS:
        ...
        extra = (('\nLa colocación alinea J104, J108, J107, J113, J109, J105 y J106 con '
                  ...
                  'y 18 vías. La barrera de 8 mm red/SELV es una regla DRC y una banda sin cobre; '
                  'el dominio de red es contiguo y el DRC de esta etapa tiene 0 infracciones. '
                  'Quedan 297 conexiones abiertas y seis diferencias de paridad: MH1–MH3 y las '
