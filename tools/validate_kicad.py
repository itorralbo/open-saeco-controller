...
def main():
    ...
    for directory, name in BOARDS:
        ...
        extra = (('\nLa colocación alinea J104, J108, J107, J113, J109, J105 y J106 con '
                  ...
                  'incorporar sus huellas. El routing reproducible cubre USB, la alimentación '
                  'y el desacoplo del STM32 y un plano GND_UI provisional en B.Cu: 93 segmentos '
                  'y 18 vías. La regla de barrera de 8 mm red/SELV está activa y el DRC de esta '
                  'etapa marca 95 infracciones, todas de la colocación de red previa (F701/F702 '
                  'junto al puente H, K701 en la zona SELV y J115 junto al buck de 12 V); '
                  'quedan 298 conexiones abiertas y seis diferencias de paridad: MH1–MH3 y las '
                  'huellas aún desconocidas de JP19/JP1/JP9.\n\n'
